...
BENCH_FPPFLAGS   = -w -m literal.pm -I. -DINTIO -DIWORDSIZE=4  -DDWORDSIZE=8 -DRWORDSIZE=4 -DLWORDSIZE=4 -DNETCDF  -DTRIEDNTRUE -DLIMIT_ARGS -DEM_CORE=1  -DNMM_CORE=0 -DNMM_MAX_DIM=1000 -DCOAMPS_CORE=0  -DEXP_CORE=0 -DF90_STANDALONE -DCONFIG_BUF_LEN=8192 -DMAX_DOMAINS_F=21 -DNO_NAMELIST_PRINT
CC               = /usr/bin/gcc
COPTIMIZE        = -O2 
CPORTABILITY     = -DSPEC_CPU_CASE_FLAG -DSPEC_CPU_LINUX
CXX              = /usr/bin/g++
CXXOPTIMIZE      = -O2 
FC               = /usr/bin/gcc/bin/gfortran
FOPTIMIZE        = -O2
FPBASE           = yes
...
commandexe       = wrf_base.amd64-m64-gcc41-nn
...
compwhite        = 
configdir        = config
configpath       = /root/asterinas/asterinas/regression/apps/speccpu2006-v1.0.1/config/test.cfg
copies           = 1
datadir          = data
delay            = 0
deletebinaries   = 0
...
log              = CPU2006
log_line_width   = 0
logname          = /root/asterinas/asterinas/regression/apps/speccpu2006-v1.0.1/result/CPU2006.001.log
lognum           = 001
mach             = default
mail_reports     = all
mailcompress     = 0
...
output_root      = 
outputdir        = output
path             = /root/asterinas/asterinas/regression/apps/speccpu2006-v1.0.1/benchspec/CPU2006/481.wrf
plain_train      = 1
prefix           = 
prepared_by      = 
rate             = 1
...
tester           = 
top              = /root/asterinas/asterinas/regression/apps/speccpu2006-v1.0.1
tune             = base
uid              = 0
unbuffer         = 1
update-flags     = 0
